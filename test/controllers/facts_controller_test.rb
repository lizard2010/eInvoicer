...
class FactsControllerTest < ActionController::TestCase
  ...
  test "should create fact" do
    assert_difference('Fact.count') do
      post :create, fact: { activity_id: @fact.activity_id, description: @fact.description, end_time: @fact.end_time, start_time: @fact.start_time }
    end
  ...
  test "should update fact" do
    patch :update, id: @fact, fact: { activity_id: @fact.activity_id, description: @fact.description, end_time: @fact.end_time, start_time: @fact.start_time }
    assert_redirected_to fact_path(assigns(:fact))
  end
